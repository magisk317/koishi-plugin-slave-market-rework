...
function createAppearanceModule(deps) {
  const { setupMessageRecall, checkTaxBeforeCommand, isAdmin, formatCostTip, getUser6, renderShopCard } = deps;
...
module.exports = { createAppearanceModule, AppearanceType, appearances };
