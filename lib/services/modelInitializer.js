function registerModels(ctx) {
  ctx.model.extend("player_market_users", {
    ...
    lastAssetDecayLoss: "integer",
    lastAssetDecayDate: "unsigned",
    lastAssetDecayNoticeDate: "unsigned",
    depositInvalidStreak: "unsigned",
    commandBanned: "boolean",
    commandBanReason: "string",
    abuseCount: "unsigned",
    lastAbuseTime: "unsigned",
    isInJail: "boolean",
    jailStartTime: "unsigned",
    jailWorkStartTime: "unsigned",
    jailReason: "string",
